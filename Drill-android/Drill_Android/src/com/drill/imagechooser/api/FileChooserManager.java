...
public class FileChooserManager extends MediaChooserManager implements com.drill.imagechooser.threads.FileProcessorListener {
    ...
    private void processFile(Intent data) {
        ...
        com.drill.imagechooser.threads.FileProcessorThread thread = new com.drill.imagechooser.threads.FileProcessorThread(dataString,
